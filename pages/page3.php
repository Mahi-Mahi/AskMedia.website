...
<a href="http://www.globaleditorsnetwork.org/dja/" target="_blank" ><img id="awards" src="img/awards.png" title="Global Editors Network - Data-Driven Storytelling Small Media Price &amp; Public price"></a>
...
<a class="previous" href="#">
	<img id="left-arrow" class="btn hires" src="img/left-arrow.png">
			    	...
			    	<div class="clients_slides_container">
				    	<ul class="clients">
				    		<li><a id="client1" class="logoclilink" target="_blank" href="http://www.leparisien.fr">
				    		<img id="clientImg1" class="logoclient" src="img/clients/lpm.png">
				    	</a><a id="client2" class="logoclilink" target="_blank" href="http://www.parismatch.fr">
				    		<img id="clientImg2" class="logoclient" src="img/clients/parismatch.png">
				    	</a><a id="client3" class="logoclilink" target="_blank" href="http://www.groupebayard.com/fr">
				    		<img id="clientImg3" class="logoclient" src="img/clients/Bayard_logo.png">
				    	</a></li>
				    	</ul>
				    <ul class="clients">
				    	<li>
				    	<a id="client4" class="logoclilink" target="_blank" href="http://www.latribune.fr">
				    		<img id="clientImg4" class="logoclient" src="img/clients/tribune.png">
				    	</a><a id="client5" class="logoclilink" target="_blank" href="http://www.wedemain.fr">
				    		<img id="clientImg5" class="logoclient" src="img/clients/WeDemain.png">
				    	</a><a id="client6" class="logoclilink" target="_blank" href="http://www.cartier.fr">
